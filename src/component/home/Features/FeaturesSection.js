        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-dark/5 bg-white p-4 transition-all duration-500 hover:border-dark/10 hover:shadow-2xl hover:shadow-dark/5">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm leading-relaxed text-dark/60 capitalize">
                Safely upload, e-sign, and store your important tax forms and
                financial records with enterprise-grade encryption.
              </p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-dark/5 bg-white p-4 transition-all duration-500 hover:border-dark/10 hover:shadow-2xl hover:shadow-dark/5">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm leading-relaxed text-dark/60 capitalize">
                View outstanding balances, track payment history, and settle
                your invoices directly through the portal in seconds.
              </p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-dark/5 bg-white p-4 transition-all duration-500 hover:border-dark/10 hover:shadow-2xl hover:shadow-dark/5">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm leading-relaxed text-dark/60 capitalize">
                Always know the exact status of your tax returns, audits, and
                compliance filings without ever having to ask.
              </p>
            </div>
          </div>
        </div>
